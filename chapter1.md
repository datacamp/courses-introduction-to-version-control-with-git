...
Every commit to a repository has a unique ID called a **hash**
...
the range of lines affected are listed between `@@` markers,
and lines that the change removed are prefixed with `-`
